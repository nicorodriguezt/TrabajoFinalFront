...
@Component({
  selector: 'app-carga-inicial-view',
  templateUrl: './carga-inicial-view.component.html',
  styleUrls: ['./carga-inicial-view.component.css'],
  providers: [DatosUsuarioService]
})
export class CargaInicialViewComponent implements OnInit {
